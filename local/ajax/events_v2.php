...
$arrEventsListMainAjax['PROPERTY'] = array_map('intval', array_filter($_REQUEST[$filterName . '_pf']));
if ($dates != '') {
    ...
    $arrEventsListMainAjax['PROPERTY']['>=DATE_FROM'] = $dateFrom;
    $arrEventsListMainAjax['PROPERTY']['<=DATE_FROM'] = $dateTo . ' 23:59:59';
}
if (empty($arrEventsListMainAjax['PROPERTY'])) {
    unset($arrEventsListMainAjax['PROPERTY']);
}
...
<div class="tabs__content js-tabs-content is-active" data-group="video">
    <?$APPLICATION->IncludeComponent(
        ...
        Array(
            ...
            "FILTER_NAME" => 'arrEventsListMainAjax',
