    ...
    <?php foreach ($arResult['ITEMS'] as $arSectionId => $arSection) { ?>
        <div class="card-list js-card-list">
            ...
            <?php foreach ($arSection as $item) { ?>
                ...
                ?>
                <a href="<?=$item['DETAIL_PAGE_URL']?>" class="card card_shadow <?=$class?>">
                    <div class="card__row-top">
                        <span class="card__label"><?=$item['PROPERTIES']['DATE_INTERVAL']['VALUE']?></span>
                    </div>
                    ...
                    <div class="card__content">
                        <div class="card__header">
                            <p class="card__address"><?=$item['PROPERTIES']['PLACE']['VALUE']?></p>
                        </div>
                    ...
                    <div class="card__footer">
                        <div class="card__theme card__theme_column">
                            ...
                            <p class="card__theme-name"><?=$item['PROPERTIES']['DISCIPLINE']['VALUE']?></p>
                        </div>
                        <div class="card__count card__count_video"><?=count($item['PROPERTIES']['FOTO']['VALUE'])?></div>
                    </div>
                </a>
            <?php } ?>
            </div>
